...
| `configContracts`                   | No       | `object`                         | Static config-contract metadata read before full plugin runtime loads, including compatibility migration paths and SecretRef/config-secret input metadata.                                                   |
| `kind`                              | No       | `"memory"` \| `"context-engine"` | Declares an exclusive plugin kind used by `plugins.slots.*`.                                                                                                                                                 |
| `channels`                          | No       | `string[]`                       | Channel ids owned by this plugin. Used for discovery and config validation.                                                                                                                                  |
| `providers`                         | No       | `string[]`                       | Provider ids owned by this plugin.                                                                                                                                                                           |
| `modelSupport`                      | No       | `object`                         | Manifest-owned shorthand model-family metadata used to auto-load the plugin before runtime.                                                                                                                  |
| `providerEndpoints`                 | No       | `object[]`                       | Manifest-owned provider endpoint metadata such as host, base URL, endpoint class, and request-family hints. Read by the control plane before provider runtime loads.                                         |
| `providerRequest`                   | No       | `object`                         | Provider request metadata such as OpenAI-compatible request family, native parameters, or routing hints. Runtime code still owns actual request execution.                                                   |
| `modelCatalog`                      | No       | `object`                         | Static model catalog rows, aliases, suppressions, and catalog ownership metadata available without loading plugin runtime.                                                                                   |
| `providerDiscoveryEntry`            | No       | `object`                         | Discovery metadata that lets provider pickers and model discovery surfaces show a provider before the runtime module loads.                                                                                  |
| `toolMetadata`                      | No       | `object`                         | Static tool descriptor and optional-tool metadata for prompt planning, status, and MCP/control-plane surfaces.                                                                                               |
| `mediaUnderstandingProviderMetadata` | No      | `object`                         | Static media-understanding provider metadata used by image/document analysis surfaces before runtime loads.                                                                                                  |
| `imageGenerationProviderMetadata`   | No       | `object`                         | Static image-generation provider metadata used by media generation setup and provider selection surfaces.                                                                                                    |
| `musicGenerationProviderMetadata`   | No       | `object`                         | Static music-generation provider metadata used by media generation setup and provider selection surfaces.                                                                                                    |
| `videoGenerationProviderMetadata`   | No       | `object`                         | Static video-generation provider metadata used by media generation setup and provider selection surfaces.                                                                                                    |
...
| Field            | Required | Type                                                 | What it means                                                     |
| ---------------- | -------- | ---------------------------------------------------- | ----------------------------------------------------------------- |
| `onStartup`      | No       | `boolean`                                            | Include the plugin in startup activation planning. Use `true` for bundled/runtime surfaces that must be available at gateway startup; omit or set `false` for provider, channel, command, or capability-triggered loading. |
