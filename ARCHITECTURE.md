...
> Updated: 2026-04-13 (docs snapshot: v2026.4.12) | Released baseline: GitHub `v2026.4.12`
...
| `extensions/` | 112 dirs | — | Channel plugins, provider auth plugins, tool/feature plugins (including `diffs`, `comfy`, and the expanded provider/plugin set on `v2026.4.12`) | plugin-sdk |
...
> Current analyzed source package: released `v2026.4.12`. Counts measured from the `v2026.4.12` released tree.
